                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <div className="text-xs space-y-1 text-muted-foreground">
                            <div>• Vendor A: ✅ Compliant (Carbon: 54/100, Rating: 1.2)</div>
                            <div>• Vendor B: ❌ Non-compliant (poor climate score)</div>
                            <div>• Vendor C: ✅ Compliant (Carbon: 66/100, Rating: 1.2)</div>
                            <div>• Vendor D: ❌ Non-compliant (budget overrun)</div>
                          </div>
                        </div>

                        <div>
                          <h3 className="font-semibold text-sm mb-2">Constraints & Weights:</h3>
                          <div className="text-xs space-y-1 text-muted-foreground">
                            <div>• Compliance: 0.8</div>
                            <div>• Climate friendly: 0.1</div>
                            <div>• Budget: 0.1</div>
                            <div>• Formula: score = 0.8×compliance + 0.1×normalized_climate + 0.1×normalized_budget</div>
                          </div>
                        </div>

                        <div>
                          <h3 className="font-semibold text-sm mb-2">Environmental and Monetary Cost of API Call:</h3>
                          <div className="text-xs space-y-1 text-muted-foreground">
                            <div>• Estimated environmental footprint: 120 kg CO2e</div>
                            <div>• Estimated monetary cost: $3.20</div>
                          </div>
                        </div>
                      </div>
